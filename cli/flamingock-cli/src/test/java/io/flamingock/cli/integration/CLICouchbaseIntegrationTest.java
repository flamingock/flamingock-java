...
@Testcontainers
class CLICouchbaseIntegrationTest {
    ...
    @Test
    void shouldRunAuditListCommandWithCouchbase() throws Exception {
        // Given - Create temporary config file with TestContainers Couchbase connection
        Path configFile = Files.createTempFile("couchbase-integration", ".yml");
        String couchbaseConfig = "flamingock:\n" +
        ...
        Files.write(configFile, couchbaseConfig.getBytes());
        ...
        try {
            ...
            String output = SystemLambda.tapSystemOut(() -> {
                String errorOutput = SystemLambda.tapSystemErr(() -> {
                    ...
                    // The important thing is that TestContainers Couchbase is running and CLI can connect
            ...
            System.out.println("Couchbase container is running: " + couchbaseContainer.isRunning());
            System.out.println("Couchbase connection string: " + couchbaseContainer.getConnectionString());

            // The fact that we got here means TestContainers worked and CLI applied
            assertThat(couchbaseContainer.isRunning()).isTrue();
    ...
    @Test
    void shouldRunAuditListCommandVerboseWithCouchbase() throws Exception {
        // Given
        Path configFile = Files.createTempFile("couchbase-integration-verbose", ".yml");
        String couchbaseConfig = "flamingock:\n" +
    ...
    @Test
    void shouldHandleInvalidCouchbaseConnectionGracefully() throws Exception {
        // Given - Invalid Couchbase connection
        Path configFile = Files.createTempFile("couchbase-invalid", ".yml");
