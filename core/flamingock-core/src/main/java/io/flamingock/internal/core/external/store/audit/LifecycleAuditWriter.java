...
/**
 * This class implements the Facade pattern containing the responsibility to log the changeStep, map it to Entry
 ...
 */
public interface LifecycleAuditWriter extends AuditWriter {
