 ...
 */
public abstract class AbstractTemplateLoadedChange<CONFIG extends TemplateField, APPLY extends TemplatePayload, ROLLBACK extends TemplatePayload> extends AbstractReflectionLoadedChange {
    ...
    protected AbstractTemplateLoadedChange(String changeFileName,
        ...
        super(changeFileName, id, order, author, templateClass, constructor, runAlways, transactionalFlag, transactional, systemChange, targetSystem, recovery, false);
