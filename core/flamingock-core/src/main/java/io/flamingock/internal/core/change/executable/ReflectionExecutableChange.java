...
/**
 * This class is a reflection version of the ExecutableChange.
 * <p>
 ...
 * concurrent changes at the same time),because after that the process will abort.
 * <p>
 ...
 * fail fast.
 */
public abstract class ReflectionExecutableChange<LOADED_CHANGE extends AbstractReflectionLoadedChange>
        extends AbstractExecutableChange<LOADED_CHANGE> implements ExecutableChange {

    protected final Method executionMethod;
    protected final Method rollbackMethod;


    public ReflectionExecutableChange(String stageName,
