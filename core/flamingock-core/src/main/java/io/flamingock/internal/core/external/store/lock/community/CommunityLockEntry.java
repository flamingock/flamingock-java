 ...
 */
package io.flamingock.internal.core.external.store.lock.community;
 ...
 * @since 27/07/2014
 */
public class CommunityLockEntry {
    ...
    public CommunityLockEntry(String key, LockStatus status, String owner, LocalDateTime expiresAt) {
        this.key = key;
        this.status = status;
        this.owner = owner;
