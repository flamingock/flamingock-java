...
public class ChangeProcessStrategyFactory {
    ...
    public ChangeProcessStrategy build() {
        ...
        return getStrategy(
                ...
                baseContext,
                executionContext,
                new ChangeResultBuilder().fromChange(change),
     ...
     */
    public static ChangeProcessStrategy getStrategy(ExecutableChange change,
    ...
    private static AuditTxType getAuditTxStrategy(ExecutableChange change, TargetSystemOps targetSystem) {
        if(!change.isTransactional()) {
