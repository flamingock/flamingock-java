...
/**
 * Executable change for simple templates (single apply/rollback step).
...
public class SimpleTemplateExecutableChange<CONFIG extends TemplateField, APPLY extends TemplatePayload, ROLLBACK extends TemplatePayload>
        extends AbstractTemplateExecutableChange<CONFIG, APPLY, ROLLBACK,
                        SimpleTemplateLoadedChange<CONFIG, APPLY, ROLLBACK>> {

    public SimpleTemplateExecutableChange(String stageName,
