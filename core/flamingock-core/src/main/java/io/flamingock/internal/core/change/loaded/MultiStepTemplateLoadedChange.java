 ...
 * at load time, enabling early validation and cleaner executable changes.
 *
...
public class MultiStepTemplateLoadedChange<CONFIG extends TemplateField, APPLY extends TemplatePayload, ROLLBACK extends TemplatePayload>
    ...
    MultiStepTemplateLoadedChange(String changeFileName,
        ...
        super(changeFileName, id, order, author, templateClass, constructor, profiles, transactionalFlag, transactional, runAlways, systemChange, configuration, targetSystem, recovery, rollbackPayloadRequired);
        this.steps = steps;
    }
