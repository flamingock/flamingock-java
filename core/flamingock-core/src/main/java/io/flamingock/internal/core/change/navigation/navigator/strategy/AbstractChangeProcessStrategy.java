 ...
 */
package io.flamingock.internal.core.change.navigation.navigator.strategy;
...
import io.flamingock.internal.core.change.navigation.navigator.ChangeProcessLogger;
import io.flamingock.internal.core.change.navigation.navigator.AuditStoreStepOperations;
...
public abstract class AbstractChangeProcessStrategy<TS_OPS extends TargetSystemOps> implements ChangeProcessStrategy {
    ...
    protected final ExecutableChange change;
     ...
     *
     * @return Change execution result with success/failure status and details
     */
    ...
    protected AfterExecutionAuditStep auditAndLogExecution(ExecutionStep executionStep) {
        ...
        stepLogger.logAuditExecutionResult(auditResult, executionStep.getLoadedChange());
