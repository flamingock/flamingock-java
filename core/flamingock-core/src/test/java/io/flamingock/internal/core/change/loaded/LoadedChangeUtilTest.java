...
class LoadedChangeUtilTest {
    ...
    void shouldExtractOrderFromInnerClassNames() {
        ...
        // Inner class format
        String result1 = ChangeOrderUtil.getMatchedOrderFromClassName(changeId, null, "io.flamingock.internal.core.change.loaded.CodeLoadedChangeBuilderTest$_100__noOrderInAnnotation");
    ...
    void shouldHandleInnerClassOrderInAnnotationMatching() {
        ...
        String className = "io.flamingock.internal.core.change.loaded.CodeLoadedChangeBuilderTest$_100__noOrderInAnnotation";
