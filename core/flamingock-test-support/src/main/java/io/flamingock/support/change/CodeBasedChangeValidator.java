 ...
 */
public final class CodeBasedChangeValidator extends ChangeValidator<CodeBasedChangeValidator> {

    private final Class<?> changeClass;
    private final Change changeAnnotation;

    CodeBasedChangeValidator(Class<?> changeClass) {
        super(
     ...
     */
    public CodeBasedChangeValidator hasRollbackMethod() {
        addAssertion(() -> {
