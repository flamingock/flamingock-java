...
public class CodePreviewChangeBuilder implements PreviewChangeBuilder<CodePreviewChange> {
    ...
    private CodePreviewChangeBuilder() {
    }

    public static CodePreviewChangeBuilder instance() {
        return new CodePreviewChangeBuilder();
    }

    public static CodePreviewChangeBuilder instance(TypeElement typeElement) {
        return  instance().setTypeElement(typeElement);
    }

    public CodePreviewChangeBuilder setId(String id) {
        this.id = id;
        return this;
    }

    public CodePreviewChangeBuilder setTargetSystem(TargetSystemDescriptor targetSystem) {
        this.targetSystem = targetSystem;
        return this;
    }

    public CodePreviewChangeBuilder setRecovery(RecoveryDescriptor recovery) {
        this.recovery = recovery;
        return this;
    }

    public CodePreviewChangeBuilder setOrder(String order) {
        this.order = order;
        return this;
    }

    public CodePreviewChangeBuilder setAuthor(String author) {
        this.author = author;
        return this;
    }

    public CodePreviewChangeBuilder setSourceClassPath(String sourceClassPath) {
        this.sourceClassPath = sourceClassPath;
        return this;
    }

    public CodePreviewChangeBuilder setConstructor(PreviewConstructor constructor) {
        this.constructor = constructor;
        return this;
    }

    public CodePreviewChangeBuilder setApplyMethod(PreviewMethod executionMethod) {
        this.applyMethod = executionMethod;
        return this;
    }

    public CodePreviewChangeBuilder setRollbackMethod(PreviewMethod rollbackMethod) {
        this.rollbackMethod = rollbackMethod;
        return this;
    }

    public CodePreviewChangeBuilder setRunAlways(boolean runAlways) {
        this.runAlways = runAlways;
        return this;
    }

    public CodePreviewChangeBuilder setTransactionalFlag(Boolean transactionalFlag) {
        this.transactionalFlag = transactionalFlag;
        return this;
    }

    public CodePreviewChangeBuilder setSystem(boolean system) {
        this.system = system;
        return this;
    }

    CodePreviewChangeBuilder setTypeElement(TypeElement typeElement) {
