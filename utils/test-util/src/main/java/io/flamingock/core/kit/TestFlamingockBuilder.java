 ...
 * settings and AuditStore. It's created by TestKit implementations and provides the same API
 ...
 */
public class TestFlamingockBuilder extends CommunityChangeRunnerBuilder {
