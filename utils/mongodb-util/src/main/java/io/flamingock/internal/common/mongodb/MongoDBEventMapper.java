...
/**
 * Maps a {@link FlamingockEvent} carrying an {@link AuditEntry} payload to/from a MongoDB {@link Document}.
 * <p>
 ...
 * <p>
 * Only {@link FlamingockEventType#CHANGE_STATE} events carry an {@link AuditEntry} payload today. Other
 * event types (e.g. {@link FlamingockEventType#EXECUTION_STATE}) carry different payloads and are not yet
...
public class MongoDBEventMapper {
    ...
    private static final FlamingockEventType SUPPORTED_EVENT_TYPE = FlamingockEventType.CHANGE_STATE;
    ...
    public Document toDocument(FlamingockEvent<AuditEntry> event) {
    ...
    public FlamingockEvent<AuditEntry> fromDocument(Document document) {
        FlamingockEventType eventType = FlamingockEventType.valueOf(document.getString(KEY_EVENT_TYPE));
    ...
    private static void requireSupportedType(FlamingockEventType eventType) {
