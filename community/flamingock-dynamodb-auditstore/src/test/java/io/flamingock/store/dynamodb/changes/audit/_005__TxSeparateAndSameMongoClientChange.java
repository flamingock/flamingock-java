 ...
 */
package io.flamingock.store.dynamodb.changes.audit;
...
/**
 * Change that produces TX_SEPARATE_NO_MARKER txStrategy via different DynamoDbClient.
 * Uses custom DynamoDBTargetSystem with different DynamoDbClient than audit storage.
 */
@TargetSystem(id = "mongo-system")
@Change(id = "tx-separate-no-marker", author = "test-author")
