...
import io.flamingock.store.dynamodb.changes.audit._003__NonTxTargetSystemChange;
import io.flamingock.store.dynamodb.changes.audit._005__TxSeparateAndSameMongoClientChange;
...
class DynamoDBAuditPersistenceE2ETest {
    ...
    void testTargetSystemIdVariations() {
        ...
        AuditTestSupport.withTestKit(testKit)
                ...
                .THEN_VerifyAuditFinalStateSequence(
                        // TxSharedDefaultChange - final state with default target system
                        APPLIED("tx-shared-default").withTargetSystemId("dynamodb"),

                        // NonTxTargetSystemChange - final state with custom target system
