...
public final class SqlAuditorDialectHelper extends AbstractSqlDialectHelper {
    ...
    public String getInsertSqlString(String tableName) {
        return String.format(
                "INSERT INTO %s (" +
                        ...
                        "execution_millis, execution_hostname, error_trace, type, tx_type, target_system_id, order_col, recovery_strategy, transaction_flag, system_change" +
                        ") VALUES (" +
                        "?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?" +
                        ")", tableName);
    }
    ...
    public String getSelectHistorySqlString(String tableName) {
        return String.format(
                "SELECT execution_id, stage_id, task_id, author, created_at, state, type, class_name, method_name, " +
                        "execution_millis, execution_hostname, metadata, system_change, error_trace, tx_type, target_system_id, order_col, recovery_strategy, transaction_flag " +
