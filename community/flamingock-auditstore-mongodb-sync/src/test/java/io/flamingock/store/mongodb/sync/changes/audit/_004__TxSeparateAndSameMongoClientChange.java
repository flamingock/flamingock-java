 ...
 */
package io.flamingock.store.mongodb.sync.changes.audit;
...
/**
 * Change that produces TX_SHARED txStrategy via explicit MongoDBSyncTargetSystem with same MongoClient.
...
public class _004__TxSeparateAndSameMongoClientChange {
    ...
    public void apply() {
        ...
        System.out.println("Executing TX_SHARED change via explicit MongoDBSyncTargetSystem with same MongoClient");
    }
}