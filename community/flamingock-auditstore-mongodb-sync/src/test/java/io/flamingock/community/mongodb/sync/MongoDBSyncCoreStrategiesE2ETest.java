...
import io.flamingock.community.mongodb.sync.changes._001__create_client_collection_happy;
import io.flamingock.community.mongodb.sync.changes._002__insert_federico_happy_non_transactional;
import io.flamingock.community.mongodb.sync.changes._002__insert_federico_happy_transactional;
import io.flamingock.community.mongodb.sync.changes._003__insert_jorge_failed_non_transactional_rollback;
 ...
 * MongoDBSyncTestKit with actual MongoDB persistence, proving the audit-store agnostic
 * design works identically across storage implementations.</p>
 */
@Testcontainers
class MongoDBSyncCoreStrategiesE2ETest {
    ...
    void testNonTransactionalChangeExecution() {
        ...
        TestKit testKit = MongoDBSyncTestKit.create(MongoDBSyncAuditStore.from(mongoDBSyncTargetSystem), mongoClient, database);
    ...
    void testAlreadyAppliedChangesSkipping() {
        ...
        TestKit secondRunKit = MongoDBSyncTestKit.create(MongoDBSyncAuditStore.from(mongoDBSyncTargetSystem), mongoClient, database);
